package com.hy.demo.util.datasource;
...
public class DynamicDataSourceAspect {
    ...
    @Before("@annotation(com.hy.demo.util.datasource.DynamicDataSourceAnnotation)") //前置通知
    ...
    @After("@annotation(com.hy.demo.util.datasource.DynamicDataSourceAnnotation)")   //后置通知
